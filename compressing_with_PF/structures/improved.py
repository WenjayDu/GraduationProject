...
def forward_fn(inputs, is_training):
    ...
    with tf.name_scope('layer_1'):
        BN1 = tf.layers.batch_normalization(inputs=inputs, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization1_1')
        ...
        BN1 = tf.layers.batch_normalization(inputs=conv1, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization1_2')
    ...
    with tf.name_scope('layer_2'):
        BN2 = tf.layers.batch_normalization(inputs=pool1, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization2_1')
        conv2 = tf.layers.conv2d(BN2, int(128 / FLAGS.divisor), 3, 1, activation=tf.nn.relu, name='conv2_1',
                                 ...
                                 kernel_regularizer=kernel_regu)
        BN2 = tf.layers.batch_normalization(inputs=conv2, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization2_2')
    ...
    with tf.name_scope('layer_3'):
        BN3 = tf.layers.batch_normalization(inputs=pool2, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization3_1')
        conv3 = tf.layers.conv2d(BN3, int(256 / FLAGS.divisor), 3, 1, activation=tf.nn.relu, name='conv3_1',
                                 ...
                                 kernel_regularizer=kernel_regu)
        BN3 = tf.layers.batch_normalization(inputs=conv3, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization3_2')
    ...
    with tf.name_scope('layer_4'):
        BN4 = tf.layers.batch_normalization(inputs=pool3, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization4_1')
        conv4 = tf.layers.conv2d(BN4, int(512 / FLAGS.divisor), 3, 1, activation=tf.nn.relu, name='conv4_1',
                                 ...
                                 kernel_regularizer=kernel_regu)
        BN4 = tf.layers.batch_normalization(inputs=conv4, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization4_2')
    ...
    with tf.name_scope('layer_5'):
        BN5 = tf.layers.batch_normalization(inputs=pool4, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization5_1')
        conv5 = tf.layers.conv2d(BN5, int(1024 / FLAGS.divisor), 3, 1, activation=tf.nn.relu, name='conv5_1',
                                 ...
                                 kernel_regularizer=kernel_regu)
        BN5 = tf.layers.batch_normalization(inputs=conv5, training=is_training, epsilon=EPS, fused=False,
                                            name='batch_normalization5_2')
