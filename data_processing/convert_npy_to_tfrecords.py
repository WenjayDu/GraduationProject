...
def convert_whole_dataset(dataset_dir_path='datasets/mri_pad_4'):
    ...
    :return:
    """
    data_dir = DATASET_DIR + dataset_dir_path + "/data"
    saving_dir = DATASET_DIR + dataset_dir_path + "/tfrecords"

    if not os.path.exists(data_dir):
        logging.error("❗Error: data dir doesn't exist in " + dataset_dir_path)
        exit(1)
