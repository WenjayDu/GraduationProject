...
def prepare_mri_dataset():
    ...
    print(current_dir_pardir)
    os.system("tar -jxvf " + current_dir_pardir + "/module_minc_keras/data/ouput.tar.bz2 &> /dev/null "
                                                  "&& mv " + current_dir_pardir + "/module_minc_keras/data/output ../datasets/mri")
