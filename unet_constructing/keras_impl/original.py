...
class UNet:
    ...
    def build_up_unet(data, class_num):
        ...
        conv1 = Convolution2D(64 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv1)
        pool1 = MaxPooling2D(pool_size=(2, 2), strides=None)(conv1)

        conv2 = Convolution2D(128 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(pool1)
        conv2 = Convolution2D(128 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv2)
        pool2 = MaxPooling2D(pool_size=(2, 2))(conv2)

        conv3 = Convolution2D(256 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(pool2)
        conv3 = Convolution2D(256 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv3)
        pool3 = MaxPooling2D(pool_size=(2, 2))(conv3)

        conv4 = Convolution2D(512 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(pool3)
        conv4 = Convolution2D(512 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv4)
        pool4 = MaxPooling2D(pool_size=(2, 2))(conv4)

        conv5 = Convolution2D(1024 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(pool4)
        conv5 = Convolution2D(1024 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv5)
        ...
        conv7 = Convolution2D(256 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conc6)
        conv7 = Convolution2D(256 / FLAGS.divisor, 3, 3, activation='relu', border_mode='same')(conv7)
