...
class UNet:
    ...
    def build_up_unet(self, batch_size):
        ...
        with tf.name_scope('layer_1'):
            # conv_1
            self.w[1] = self.init_w(shape=[3, 3, FLAGS.input_shape[2], 32], name='w_1')
            ...
            # conv_2
            self.w[2] = self.init_w(shape=[3, 3, 32, 32], name='w_2')
        ...
        with tf.name_scope('layer_2'):
            # conv_1
            self.w[3] = self.init_w(shape=[3, 3, 32, 64], name='w_3')
            ...
            # conv_2
            self.w[4] = self.init_w(shape=[3, 3, 64, 64], name='w_4')
        ...
        with tf.name_scope('layer_3'):
            # conv_1
            self.w[5] = self.init_w(shape=[3, 3, 64, 128], name='w_5')
            conv_1_result = tf.nn.conv2d(input=maxpool_result, filter=self.w[5], strides=[1, 1, 1, 1],
                                         padding='SAME', name='conv_1')
            relu_1_result = tf.nn.relu(features=conv_1_result, name='relu_1')

            # conv_2
            self.w[6] = self.init_w(shape=[3, 3, 128, 128], name='w_6')
            conv_2_result = tf.nn.conv2d(input=relu_1_result, filter=self.w[6], strides=[1, 1, 1, 1],
                                         padding='SAME', name='conv_2')
            relu_2_result = tf.nn.relu(features=conv_2_result, name='relu_2')
        ...
        with tf.name_scope('layer_4'):
            # conv_1
            self.w[7] = self.init_w(shape=[3, 3, 128, 256], name='w_7')
            conv_1_result = tf.nn.conv2d(input=maxpool_result, filter=self.w[7], strides=[1, 1, 1, 1],
                                         padding='SAME', name='conv_1')
            relu_1_result = tf.nn.relu(features=conv_1_result, name='relu_1')

            # conv_2
            self.w[8] = self.init_w(shape=[3, 3, 256, 256], name='w_8')
        ...
        with tf.name_scope('layer_9'):
            ...
            # conv_1
            self.w[21] = self.init_w(shape=[3, 3, 64, 32], name='w_12')
            conv_1_result = tf.nn.conv2d(input=result_merge, filter=self.w[21], strides=[1, 1, 1, 1],
                                         padding='SAME', name='conv_1')
            relu_1_result = tf.nn.relu(features=conv_1_result, name='relu_1')

            # conv_2
            self.w[22] = self.init_w(shape=[3, 3, 32, 32], name='w_10')
            ...
            self.w[23] = self.init_w(shape=[1, 1, 32, 3], name='w_11')
